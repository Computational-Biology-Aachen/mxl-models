...
def _moiety_2(x1: float, x2: float, total: float) -> float:
    return total - x1 - x2
...
def _mass_action_2s(s1: float, s2: float, k_fwd: float) -> float:
    return k_fwd * s1 * s2
...
def create_model() -> Model:
    ...
    m = m.add_parameter("PPFD", _value=100.0)
    m = m.add_parameter("CO2 (dissolved)", _value=0.013226)
    m = m.add_parameter("O2 (dissolved)_lumen", _value=8.0)
    m = m.add_parameter("bH", _value=100.0)
    m = m.add_parameter("F", _value=96.485)
    m = m.add_parameter("E^0_PC", _value=0.38)
    m = m.add_parameter("E^0_P700", _value=0.48)
    m = m.add_parameter("E^0_FA", _value=-0.55)
    m = m.add_parameter("E^0_Fd", _value=-0.43)
    m = m.add_parameter("E^0_NADP", _value=-0.113)
    m = m.add_parameter("convf", _value=0.032)
    m = m.add_parameter("R", _value=0.0083)
    m = m.add_parameter("T", _value=298.0)
    m = m.add_parameter("Carotenoids_tot", _value=1.0)
    m = m.add_parameter("Fd*", _value=5.0)
    m = m.add_parameter("PC_tot", _value=4.0)
    m = m.add_parameter("PSBS_tot", _value=1.0)
    m = m.add_parameter("LHC_tot", _value=1.0)
    m = m.add_parameter("gamma0", _value=0.06260060801266355)
    m = m.add_parameter("gamma1", _value=0.4053583123566203)
    m = m.add_parameter("gamma2", _value=0.7040758738825375)
    m = m.add_parameter("gamma3", _value=0.07834807781016208)
    m = m.add_parameter("kZSat", _value=0.12)
    m = m.add_parameter("E^0_QA", _value=-0.14)
    m = m.add_parameter("E^0_PQ", _value=0.354)
    m = m.add_parameter("PQ_tot", _value=17.5)
    m = m.add_parameter("staticAntII", _value=0.1)
    m = m.add_parameter("staticAntI", _value=0.37)
    m = m.add_parameter("Thioredoxin_tot", _value=1.0)
    m = m.add_parameter("E_total", _value=6.0)
    m = m.add_parameter("NADP*", _value=0.8)
    m = m.add_parameter("A*P", _value=2.55)
    m = m.add_parameter("Pi_tot", _value=17.05)
    m = m.add_parameter("kf_ferredoxin_thioredoxin_reductase", _value=0.8)
    m = m.add_parameter("kf_tr_activation", _value=1.0)
    m = m.add_parameter("kf_tr_inactivation", _value=0.1)
    m = m.add_parameter("ASC_tot*", _value=10)
    m = m.add_parameter("Glutathion_tot", _value=10.0)
    m = m.add_parameter("kf_atp_synthase", _value=20.0)
    m = m.add_parameter("HPR", _value=4.666666666666667)
    m = m.add_parameter("Pi_mol", _value=0.01)
    m = m.add_parameter("DeltaG0_ATP", _value=30.6)
    m = m.add_parameter("kh_lhc_protonation", _value=10)
    m = m.add_parameter("kf_lhc_protonation", _value=0.15837051384170664)
    m = m.add_parameter("ksat_lhc_protonation", _value=6.2539066418842255)
    m = m.add_parameter("kf_lhc_deprotonation", _value=0.015892570403695704)
    m = m.add_parameter("kf_cyclic_electron_flow", _value=1.0)
    m = m.add_parameter("kf_violaxanthin_deepoxidase", _value=0.0006091912188339879)
    m = m.add_parameter("kh_violaxanthin_deepoxidase", _value=4)
    m = m.add_parameter("ksat_violaxanthin_deepoxidase", _value=6.193595407850397)
    m = m.add_parameter("kf_zeaxanthin_epoxidase", _value=0.000106261953934132)
    m = m.add_parameter("km_fnr_Ferredoxine (reduced)", _value=1.56)
    m = m.add_parameter("km_fnr_NADP", _value=0.22)
    m = m.add_parameter("E0_fnr", _value=3.0)
    m = m.add_parameter("kcat_fnr", _value=500.0)
    m = m.add_parameter("kf_ndh", _value=0.002)
    m = m.add_parameter("PSII_total", _value=2.5)
    m = m.add_parameter("PSI_total", _value=2.5)
    m = m.add_parameter("kH0", _value=500000000.0)
    m = m.add_parameter("kPQred", _value=250.0)
    m = m.add_parameter("kPCox", _value=2500.0)
    m = m.add_parameter("kFdred", _value=250000.0)
    m = m.add_parameter("k2", _value=5000000000.0)
    m = m.add_parameter("kH", _value=5000000000.0)
    m = m.add_parameter("kF", _value=625000000.0)
    m = m.add_parameter("kMehler", _value=1.0)
    m = m.add_parameter("kf_proton_leak", _value=10.0)
    m = m.add_parameter("kPTOX", _value=0.01)
    m = m.add_parameter("kStt7", _value=0.0035)
    m = m.add_parameter("km_lhc_state_transition_12", _value=0.2)
    m = m.add_parameter("n_ST", _value=2.0)
    m = m.add_parameter("kPph1", _value=0.0013)
    m = m.add_parameter("E0_rubisco", _value=1.0)
    m = m.add_parameter("kcat_rubisco_carboxylase", _value=2.72)
    m = m.add_parameter("km_rubisco_carboxylase_RUBP", _value=0.02)
    m = m.add_parameter("km_rubisco_carboxylase_CO2 (dissolved)", _value=0.0107)
    m = m.add_parameter("ki_rubisco_carboxylase_3PGA", _value=0.04)
    m = m.add_parameter("ki_rubisco_carboxylase_FBP", _value=0.04)
    m = m.add_parameter("ki_rubisco_carboxylase_SBP", _value=0.075)
    m = m.add_parameter("ki_rubisco_carboxylase_Orthophosphate", _value=0.9)
    m = m.add_parameter("ki_rubisco_carboxylase_NADPH", _value=0.07)
    m = m.add_parameter("kre_phosphoglycerate_kinase", _value=800000000.0)
    m = m.add_parameter("keq_phosphoglycerate_kinase", _value=0.00031)
    m = m.add_parameter("kre_gadph", _value=800000000.0)
    m = m.add_parameter("keq_gadph", _value=16000000.0)
    m = m.add_parameter("kre_triose_phosphate_isomerase", _value=800000000.0)
    m = m.add_parameter("keq_triose_phosphate_isomerase", _value=22.0)
    m = m.add_parameter("kre_aldolase_dhap_gap", _value=800000000.0)
    m = m.add_parameter("keq_aldolase_dhap_gap", _value=7.1)
    m = m.add_parameter("kre_aldolase_dhap_e4p", _value=800000000.0)
    m = m.add_parameter("keq_aldolase_dhap_e4p", _value=13.0)
    m = m.add_parameter("E0_fbpase", _value=1.0)
    m = m.add_parameter("kcat_fbpase", _value=1.6)
    m = m.add_parameter("km_fbpase_s", _value=0.03)
    m = m.add_parameter("ki_fbpase_F6P", _value=0.7)
    m = m.add_parameter("ki_fbpase_Orthophosphate", _value=12.0)
    m = m.add_parameter("kre_transketolase_gap_f6p", _value=800000000.0)
    m = m.add_parameter("keq_transketolase_gap_f6p", _value=0.084)
    m = m.add_parameter("kre_transketolase_gap_s7p", _value=800000000.0)
    m = m.add_parameter("keq_transketolase_gap_s7p", _value=0.85)
    m = m.add_parameter("E0_SBPase", _value=1.0)
    m = m.add_parameter("kcat_SBPase", _value=0.32)
    m = m.add_parameter("km_SBPase_s", _value=0.013)
    m = m.add_parameter("ki_SBPase_Orthophosphate", _value=12.0)
    m = m.add_parameter("kre_ribose_phosphate_isomerase", _value=800000000.0)
    m = m.add_parameter("keq_ribose_phosphate_isomerase", _value=0.4)
    m = m.add_parameter("kre_ribulose_phosphate_epimerase", _value=800000000.0)
    m = m.add_parameter("keq_ribulose_phosphate_epimerase", _value=0.67)
    m = m.add_parameter("E0_phosphoribulokinase", _value=1.0)
    m = m.add_parameter("kcat_phosphoribulokinase", _value=7.9992)
    m = m.add_parameter("km_phosphoribulokinase_RU5P", _value=0.05)
    m = m.add_parameter("km_phosphoribulokinase_ATP", _value=0.05)
    m = m.add_parameter("ki_phosphoribulokinase_3PGA", _value=2.0)
    m = m.add_parameter("ki_phosphoribulokinase_RUBP", _value=0.7)
    m = m.add_parameter("ki_phosphoribulokinase_Orthophosphate", _value=4.0)
    m = m.add_parameter("ki_phosphoribulokinase_4", _value=2.5)
    m = m.add_parameter("ki_phosphoribulokinase_5", _value=0.4)
    m = m.add_parameter("kre_g6pi", _value=800000000.0)
    m = m.add_parameter("keq_g6pi", _value=2.3)
    m = m.add_parameter("kre_phosphoglucomutase", _value=800000000.0)
    m = m.add_parameter("keq_phosphoglucomutase", _value=0.058)
    m = m.add_parameter("Orthophosphate (external)", _value=0.5)
    m = m.add_parameter("km_ex_pga", _value=0.25)
    m = m.add_parameter("km_ex_gap", _value=0.075)
    m = m.add_parameter("km_ex_dhap", _value=0.077)
    m = m.add_parameter("km_N_translocator_Orthophosphate (external)", _value=0.74)
    m = m.add_parameter("km_N_translocator_Orthophosphate", _value=0.63)
    m = m.add_parameter("kcat_N_translocator", _value=2.0)
    m = m.add_parameter("E0_N_translocator", _value=1.0)
    m = m.add_parameter("E0_ex_g1p", _value=1.0)
    m = m.add_parameter("km_ex_g1p_G1P", _value=0.08)
    m = m.add_parameter("km_ex_g1p_ATP", _value=0.08)
    m = m.add_parameter("ki_ex_g1p", _value=10.0)
    m = m.add_parameter("ki_ex_g1p_3PGA", _value=0.1)
    m = m.add_parameter("ki_ex_g1p_F6P", _value=0.02)
    m = m.add_parameter("ki_ex_g1p_FBP", _value=0.02)
    m = m.add_parameter("kcat_ex_g1p", _value=0.32)
    m = m.add_parameter("kf_mda_reductase_1", _value=500.0)
    m = m.add_parameter("E0_mda_reductase_2", _value=0.002)
    m = m.add_parameter("kcat_mda_reductase_2", _value=300.0)
    m = m.add_parameter("km_mda_reductase_2_NADPH", _value=0.023)
    m = m.add_parameter("km_mda_reductase_2_MDA", _value=0.0014)
    m = m.add_parameter("kf1", _value=10000.0)
    m = m.add_parameter("kr1", _value=220.0)
    m = m.add_parameter("kf2", _value=10000.0)
    m = m.add_parameter("kr2", _value=4000.0)
    m = m.add_parameter("kf3", _value=2510.0)
    m = m.add_parameter("kf4", _value=10000.0)
    m = m.add_parameter("kr4", _value=4000.0)
    m = m.add_parameter("kf5", _value=2510.0)
    m = m.add_parameter("XT", _value=0.07)
    m = m.add_parameter("E0_glutathion_reductase", _value=0.0014)
    m = m.add_parameter("kcat_glutathion_reductase", _value=595)
    m = m.add_parameter("km_glutathion_reductase_NADPH", _value=0.003)
    m = m.add_parameter("km_glutathion_reductase_GSSG", _value=0.2)
    m = m.add_parameter("km_dehydroascorbate_reductase_DHA", _value=0.07)
    m = m.add_parameter("km_dehydroascorbate_reductase_GSH", _value=2.5)
    m = m.add_parameter("K", _value=0.5)
    m = m.add_parameter("E0_dehydroascorbate_reductase", _value=0.0017)
    m = m.add_parameter("kcat_dehydroascorbate_reductase", _value=142)
    m = m.add_parameter("kf_ex_atp", _value=0.5)
    m = m.add_parameter("kf_ex_nadph", _value=0.5)
    m = m.add_parameter("kH_Qslope", _value=30000000000.0)
    m = m.add_parameter("b6f_content", _value=1)
    m = m.add_parameter("max_b6f", _value=500)
    m = m.add_parameter("pKreg", _value=7)
    m = m.add_parameter("stroma_buffering", _value=400)
    m = m.add_parameter("kActATPase", _value=0.001)
    m = m.add_parameter("kDeactATPase", _value=0.002)
    m = m.add_parameter("k_ATPsynthase", _value=20)
    m = m.add_parameter("b", _value=1.8688304401249531)
    m = m.add_parameter("pK0E", _value=5.960025833706074)
    m = m.add_parameter("k_import_ATP", _value=0.5)
    m = m.add_parameter("k_import_NADPH", _value=0.5)
    m = m.add_parameter("volts_per_charge", _value=0.000769481926574965)
    m = m.add_parameter("ClCe_PQ", _value=15.87880046767565)
    m = m.add_parameter("Cl_leak_PQ", _value=14.92901445507139)
    m = m.add_parameter("KEA3_ATP_treshold", _value=0.26274793681796166)
    m = m.add_parameter("KEA3_pH_reg", _value=7.69)
    m = m.add_parameter("K_delta_psi_treshold", _value=0.08146807307624158)
    m = m.add_parameter("VCCN_delta_psi_treshold", _value=0.08000900979332677)
    m = m.add_parameter("k_Cl_leak", _value=25)
    m = m.add_parameter("k_NDH1", _value=7.447430768265866)
    m = m.add_parameter("k_KEA", _value=90)
    m = m.add_parameter("perm_K", _value=1.6113135416150155)
    m = m.add_parameter("k_VCCN1", _value=0.5)
    m = m.add_parameter("k_ClCe", _value=0.5)
    m = m.add_parameter("K_total", _value=60)
    m = m.add_parameter("Cl_total", _value=50)
    m = m.add_parameter("ClCe_ATP_threshold", _value=0.2)
    m = m.add_derived(
        "RT",
        fn=_mass_action_1s,
        args=["R", "T"],
