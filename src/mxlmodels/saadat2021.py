...
def _keq_pcp700(
    ...
    """Equilibrium constant for PC -> P700 electron transfer.
...
def _keq_faf_d(
    ...
    """Equilibrium constant for FA -> Fd electron transfer.
...
def get_saadat2021() -> Model:
    """Saadat 2021 chloroplast model with ROS scavenging, Calvin cycle, and
